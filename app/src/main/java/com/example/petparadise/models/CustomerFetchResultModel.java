...
public class CustomerFetchResultModel {

    public String cust_id,branch_id,Customer_ID,Customer_Name,Address,packages,packages1,Contact_No,State,GSTIN,account_Balance,reminder,date,status_wait,finish_status,Status,grooming_done,branch_name,pets_id,pets_name,breed,dob,type;

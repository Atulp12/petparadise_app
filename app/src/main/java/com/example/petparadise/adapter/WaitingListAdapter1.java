...
public class WaitingListAdapter1 extends RecyclerView.Adapter<WaitingListAdapter1.MyViewHolder>{
    Context context;
    private List<WaitingListResultModel> getDetails;
   WaitingListAdapter1.OnItemClickListener listener;
    String demo;

    public WaitingListAdapter1(Context context, List<WaitingListResultModel> getDetails, WaitingListAdapter1.OnItemClickListener listener) {
    ...
    @Override
    public WaitingListAdapter1.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.waiting_list_item, parent, false);
        return new WaitingListAdapter1.MyViewHolder(view);
    }


    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(WaitingListAdapter1.MyViewHolder holder, final int position) {
        ...
        if(getData.getStatus_wait().equals("Waiting")){
...
//            detailBtn = itemView.findViewById(R.id.detailBtn);
        ...
        public void bind(final WaitingListResultModel getData, final WaitingListAdapter1.OnItemClickListener listener, final String s) {
